...
export default function VirtualCompatibilityTools() {
    ...
    useEffect(() => {
        ...
        const checkTextExists = async () => {
            ...
            const response = await fetch(`your_websocket_endpoint?text=${textFieldValue}`);
                ...
                <Field
                    ...
                    description={
                        <TextField
                            ...
                            description={isTextExists ? "There is already a virtual compatibility tool with this name" : "Enter a name for your virtual compatibility tool"}
